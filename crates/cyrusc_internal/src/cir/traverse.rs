...
// use cyrusc_typed_ast::format::DeclFormatterFn;
// use cyrusc_typed_ast::backup_typed_ast_generics::generic_type::GenericType;
// use cyrusc_typed_ast::backup_typed_ast_generics::mapping_ctx_arena::GenericMappingCtxArena;
// use cyrusc_typed_ast::backup_typed_ast_generics::substitute::*;
...
//                 let tag = enum_ty.compute_variant_tag(&unnamed_enum_value.variant_name.value).unwrap();
...
//         if let Some(resolved_struct) = symbol_entry.as_struct() {
//             CIRTy::Struct(self.lower_struct_sig_as_struct_ty(&resolved_struct.struct_decl))
//         } else if let Some(resolved_union) = symbol_entry.as_union() {
//             CIRTy::Union(self.lower_union_sig_as_union_ty(&resolved_union.union_decl))
//         } else if let Some(resolved_enum) = symbol_entry.as_enum() {
//             CIRTy::Enum(self.lower_enum_sig_as_enum_ty(&resolved_enum.enum_decl))
//         } else {
//             unreachable!()
//         }
//     }
