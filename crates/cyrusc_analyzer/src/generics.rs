...
// impl<'a> AnalysisContext<'a> {
    ...
    //     //         .resolve_template(func_decl.symbol_id.unwrap())
    //     //         .unwrap()
    //     //         .clone();

    //     //     let mapping = generic_type.mapping_ctx.borrow().clone();
    //     //     let base = func_decl.symbol_id.unwrap();
    ...
    //     //     .resolver
    //     //     .resolve_local_scope(func_decl.module_id, template_body.scope_id)
    //     //     .unwrap();
    ...
    //     // self.fenv.current_func = Some(typed_func_type_from_func_sig(func_decl));
    //     // self.substitute_func_params_in_body_scope(new_body_scope_id, &func_decl.params);
    ...
    //     //     self.analyze_generic_self_modifier(new_body_scope_id, &func_decl.params, sema_type);
    //     // }
    ...
    //     // self.analyze_func_body(&mut analyzed_body, &func_decl.ret_type);
