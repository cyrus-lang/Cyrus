...
trait GenericMonomorphTarget<'a> {
    fn build_monomorph(
        &self,
        codegen_llvm: &mut CodeGenBuilder<'a>,
...
impl<'a> GenericMonomorphTarget<'a> for ResolvedEnum {
    fn build_monomorph(
        ...
        let enum_struct_type = codegen_llvm.get_or_declare_enum_monomorph(resolved_enum, type_args).0;
