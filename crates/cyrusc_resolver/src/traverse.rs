...
impl Resolver {
        ...
        let result = match &type_specifier {
            TypeSpecifier::GenericInst(generic_inst) => {
                ...
                if let Some(symbol_id) = base.const_inner().as_unresolved_symbol() {
                    ...
                    Ok(SemanticType::GenericType(GenericType {
                        ...
                        is_const,
                        loc: Loc::from_loc(generic_inst.loc.clone(), self.current_file_path()),
                    }))
                } else {
            ...
            TypeSpecifier::Tuple(tuple_type) => {
                ...
                Ok(SemanticType::Tuple(TypedTupleType {
                    type_list,
                    loc: Loc::from_loc(tuple_type.loc.clone(), self.current_file_path()),
                }))
            }
            TypeSpecifier::FuncType(func_type) => {
                ...
                Ok(SemanticType::FuncType(TypedFuncType {
                    ...
                    is_public: true,
                    loc: Loc::from_loc(loc.clone(), self.current_file_path()),
                }))
            }
            ...
            TypeSpecifier::UnnamedUnion(unnamed_union_type) => {
                ...
                for field in &unnamed_union_type.fields {
                    if let Some(ty) = self.resolve_type(
                        ...
                        fields.push(TypedUnnamedUnionTypeField {
                            ...
                            ty: Box::new(ty),
                            loc: Loc::from_loc(field.loc.clone(), self.current_file_path()),
                        });
                    }
                }
                ...
                Ok(SemanticType::UnnamedUnion(TypedUnnamedUnionType {
                    ...
                    loc: Loc::from_loc(unnamed_union_type.loc.clone(), self.current_file_path()),
                }))
            }
            TypeSpecifier::UnnamedEnum(unnamed_enum_type) => {
                ...
                Ok(SemanticType::UnnamedEnum(TypedUnnamedEnumType {
                    ...
                    loc: Loc::from_loc(unnamed_enum_type.loc.clone(), self.current_file_path()),
                }))
            }
            TypeSpecifier::UnnamedStruct(unnamed_struct_type) => {
                ...
                Ok(SemanticType::UnnamedStruct(TypedUnnamedStructType {
                    ...
                    loc: Loc::from_loc(unnamed_struct_type.loc.clone(), self.current_file_path()),
                }))
            }
            ...
            TypeSpecifier::SelfType(self_type) => Ok(SemanticType::SelfType(TypedSelfType {
                loc: Loc::from_loc(self_type.loc.clone(), self.current_file_path()),
            })),
        };
    ...
    fn resolve_typedef(&mut self, typedef: &Typedef) -> Option<TypedStmt> {
        ...
        let typedef_sig = TypedefSig {
            ...
            loc: Loc::from_loc(typedef.loc.clone(), self.current_file_path()),
        };
    ...
    fn resolve_builtin_scope(&self, module_id: ModuleID, builtin_scope: &BuiltinScope) -> Option<TypedBuiltin> {
        todo!();
    }

    fn resolve_interface_stmt(&mut self, module_id: ModuleID, interface: &Interface) -> Option<TypedStmt> {
        ...
        let typed_methods: Vec<TypedFuncDeclStmt> = interface
            ...
            .filter_map(|func_decl| {
                ...
                Some(TypedFuncDeclStmt {
                    ...
                    renamed_as: None,
                    loc: Loc::from_loc(func_decl.loc.clone(), self.current_file_path()),
                })
            })
            .collect();
        ...
        let resolved_interface = ResolvedInterface {
            ...
            interface_sig: InterfaceSig {
                ...
                loc: Loc::from_loc(interface.loc.clone(), self.current_file_path()),
            },
        };
    ...
    fn resolve_union_stmt(
        ...
        let resolved_union = ResolvedUnion {
            ...
            union_sig: UnionSig {
                ...
                loc: Loc::from_loc(union_decl.loc.clone(), self.current_file_path()),
            },
        };
        ...
        Some(TypedStmt::Union(TypedUnionStmt {
            ...
            modifiers: union_decl.modifiers.clone(),
            impls,
            loc: Loc::from_loc(union_decl.ident.loc.clone(), self.current_file_path()),
            align: union_decl.align.clone(),
            is_local: is_local,
        }))
    }
    ...
    fn resolve_enum_stmt(
        ...
        let resolved_enum = ResolvedEnum {
            ...
            enum_sig: EnumSig {
                ...
                loc: Loc::from_loc(enum_decl.loc.clone(), self.current_file_path()),
            },
        };
        ...
        Some(TypedStmt::Enum(TypedEnumStmt {
            ...
            modifiers: enum_decl.modifiers.clone(),
            align: enum_decl.align.clone(),
            loc: Loc::from_loc(enum_decl.ident.loc.clone(), self.current_file_path()),
            is_local,
        }))
    }
    ...
    fn resolve_global_var_stmt(&mut self, module_id: ModuleID, global_var: &GlobalVar) -> Option<TypedStmt> {
        ...
        let resolved_global_var = ResolvedGlobalVar {
            ...
            global_var_sig: GlobalVarSig {
                ...
                loc: Loc::from_loc(global_var.loc.clone(), self.current_file_path()),
            },
        };
    ...
    fn resolve_struct_stmt(
        ...
        let resolved_struct = ResolvedStruct {
            ...
            struct_sig: StructSig {
                ...
                loc: Loc::from_loc(struct_decl.loc.clone(), self.current_file_path()),
            },
        };
            ...
            match param {
                        ...
                        scope.insert(
                            ...
                            LocalSymbol::new(LocalSymbolKind::Variable(ResolvedVariable {
                                ...
                                typed_variable: TypedVarStmt {
                                    ...
                                    is_const: false,
                                    analyzed: true,
                                    loc: Loc::from_loc(func_param.loc.clone(), self.current_file_path()),
                                },
                            })),
                        );
                    }
                ...
                FuncParamKind::SelfModifier(self_modifier) => {
                    func_params.push(TypedFuncParamKind::SelfModifier(TypedSelfModifier {
                        ...
                        loc: Loc::from_loc(self_modifier.loc.clone(), self.current_file_path()),
                    }));
                }
            }
        }
    ...
    fn resolve_if_stmt(&mut self, module_id: ModuleID, scope: LocalScopeRef, if_stmt: &If) -> Option<TypedIfStmt> {
        ...
        Some(TypedIfStmt {
            ...
            then_block,
            branches,
            loc: Loc::from_loc(if_stmt.loc.clone(), self.current_file_path()),
        })
    }
    ...
    fn resolve_block_stmt(
                ...
                Stmt::Defer(defer) => {
                    if let Some(typed_stmt) = self.resolve_stmt(module_id, scope_id, scope.clone(), &defer.operand) {
                        defers.push(TypedDeferStmt {
                            ...
                            loc: Loc::from_loc(defer.loc.clone(), self.current_file_path()),
                        });
                    }
                }
                _ => {
        ...
        Some(TypedBlockStmt {
            ...
            stmts: typed_body,
            defers,
            loc: Loc::from_loc(block_statement.loc.clone(), self.current_file_path()),
        })
    }
    ...
    fn resolve_export_tuple(
        ...
        let define_identifier = |this: &mut Resolver, ident: &Ident| -> Option<SymbolID> {
            ...
            let typed_variable = TypedVarStmt {
                ...
                loc: Loc::from_loc(ident.loc.clone(), this.current_file_path()),
            };
        ...
        Some(TypedStmt::ExportTuple(TypedExportTupleStmt {
            ...
            rhs: typed_rhs,
            is_const: export_tuple.is_const,
            loc: Loc::from_loc(export_tuple.loc.clone(), self.current_file_path()),
        }))
    }
        ...
        let typed_stmt = match stmt {
            ...
            Stmt::Return(return_stmt) => {
                ...
                Some(TypedStmt::Return(TypedReturnStmt {
                    arg,
                    loc: Loc::from_loc(return_stmt.loc.clone(), self.current_file_path()),
                }))
            }
            Stmt::Foreach(..) => todo!(),
            Stmt::For(for_stmt) => {
                ...
                Some(TypedStmt::For(TypedForStmt {
                    ...
                    increment,
                    body,
                    loc: Loc::from_loc(for_stmt.loc.clone(), self.current_file_path()),
                }))
            }
            Stmt::While(while_stmt) => {
                ...
                Some(TypedStmt::While(TypedWhileStmt {
                    ...
                    loc: Loc::from_loc(while_stmt.loc.clone(), self.current_file_path()),
                }))
            }
            Stmt::Switch(switch) => {
                ...
                for case in &switch.cases {
                        ...
                        let typed_pattern = match pattern {
                            ...
                            SwitchCasePattern::Range(range) => {
                                ...
                                TypedSwitchCasePattern::Range(TypedRange {
                                    ...
                                    loc: Loc::from_loc(range.loc.clone(), self.current_file_path()),
                                })
                            }
                        };
                    ...
                    cases.push(TypedSwitchCase {
                        patterns,
                        body: Box::new(body),
                        loc: Loc::from_loc(case.loc.clone(), self.current_file_path()),
                    });
                    drop(case_scope_rc);
                }
                ...
                Some(TypedStmt::Switch(TypedSwitchStmt {
                    ...
                    cases,
                    default_case,
                    loc: Loc::from_loc(switch.loc.clone(), self.current_file_path()),
                }))
            }
            Stmt::Enum(enum_decl) => {
                let typed_stmt =
            ...
            Stmt::Break(break_stmt) => Some(TypedStmt::Break(TypedBreakStmt {
                loc: Loc::from_loc(break_stmt.loc.clone(), self.current_file_path()),
            })),
    ...
    fn resolve_goto(&self, goto: &Goto) -> Option<TypedStmt> {
        Some(TypedStmt::Goto(TypedGotoStmt {
            ...
            label_id: None,
            loc: Loc::from_loc(goto.loc.clone(), self.current_file_path()),
        }))
    }
    ...
    fn resolve_label(&mut self, scope: LocalScopeRef, label: &Label) -> Option<TypedStmt> {
        ...
        Some(TypedStmt::Label(TypedLabelStmt {
            ...
            label_id,
            loc: Loc::from_loc(label.loc.clone(), self.current_file_path()),
        }))
    }
    ...
    fn resolve_unnamed_union_value(
        ...
        let kind = TypedExprKind::UnnamedUnionValue(TypedUnnamedUnionValue {
            ...
            loc: Loc::from_loc(unnamed_union_value.loc.clone(), self.current_file_path()),
        });
    ...
    fn resolve_unnamed_enum_value(
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::UnnamedEnumValue(TypedUnnamedEnumValue {
                ...
                kind,
                enum_ty: None,
                loc: Loc::from_loc(unnamed_enum_value.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(unnamed_enum_value.loc.clone(), self.current_file_path()),
    ...
    fn resolve_dynamic_expr(&mut self, module_id: ModuleID, dynamic_expr: &Dynamic) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Dynamic(TypedDynamicExpr {
                ...
                vtable_id: None,
                object_name: None,
                loc: Loc::from_loc(dynamic_expr.loc.clone(), self.current_file_path()),
            }),
            sema_ty: None,
            mloc: MemoryLocation::RValue,
            loc: Loc::from_loc(dynamic_expr.loc.clone(), self.current_file_path()),
    ...
    fn resolve_tuple_member_access(
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::TupleAccess(TypedTupleAccessExpr {
                ...
                loc: Loc::from_loc(tuple_member_access.loc.clone(), self.current_file_path()),
            }),
            sema_ty: None,
            mloc: MemoryLocation::LValue,
            loc: Loc::from_loc(tuple_member_access.loc.clone(), self.current_file_path()),
    ...
    fn resolve_tuple_expr(&mut self, module_id: ModuleID, tuple_value: &TupleValue) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Tuple(TypedTupleExpr {
                elements: expr_list,
                loc: Loc::from_loc(tuple_value.loc.clone(), self.current_file_path()),
            }),
            sema_ty: None,
            mloc: MemoryLocation::RValue,
            loc: Loc::from_loc(tuple_value.loc.clone(), self.current_file_path()),
    ...
    fn resolve_field_access(&mut self, module_id: ModuleID, field_access: &FieldAccess) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::FieldAccess(TypedFieldAccess {
                ...
                type_args,
                loc: Loc::from_loc(field_access.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::LValue,
            sema_ty: None,
            loc: Loc::from_loc(field_access.loc.clone(), self.current_file_path()),
    ...
    fn resolve_method_call(&mut self, module_id: ModuleID, method_call: &MethodCall) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::MethodCall(TypedMethodCall {
                ...
                loc: Loc::from_loc(method_call.loc.clone(), self.current_file_path()),
                args,
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
    ...
    fn resolve_struct_init(&mut self, module_id: ModuleID, struct_init: &StructInit) -> Option<TypedExprStmt> {
            ...
            .filter_map(|field_init| {
                self.resolve_expr(module_id, scope_opt.clone(), &field_init.value)
                    .map(|value| TypedStructFieldInit {
                        ...
                        value,
                        loc: Loc::from_loc(field_init.loc.clone(), self.current_file_path()),
                    })
            })
            .collect();
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::StructInit(TypedStructInitExpr {
                ...
                loc: Loc::from_loc(struct_init.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(struct_init.loc.clone(), self.current_file_path()),
    ...
    fn resolve_func_call(&mut self, module_id: ModuleID, func_call: &FuncCall) -> Option<TypedExprStmt> {
        if scope_required!(self, scope_opt, func_call.loc.clone(), func_call.span.end) {
            return None;
        }
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::FuncCall(TypedFuncCall {
                ...
                return_type: None,
                monomorph_key: None,
                loc: Loc::from_loc(func_call.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(func_call.loc.clone(), self.current_file_path()),
    ...
    fn resolve_untyped_array_expr(
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Array(TypedArrayExpr {
                ...
                loc: Loc::from_loc(untyped_array.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(untyped_array.loc.clone(), self.current_file_path()),
    ...
    fn resolve_array_expr(&mut self, module_id: ModuleID, arr: &Array) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Array(TypedArrayExpr {
                ...
                elements: typed_elements,
                loc: Loc::from_loc(arr.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(arr.loc.clone(), self.current_file_path()),
    ...
    fn resolve_infix_expr(&mut self, module_id: ModuleID, bin: &InfixExpr) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Infix(TypedInfixExpr {
                ...
                rhs: Box::new(rhs),
                op: bin.op.clone(),
                loc: Loc::from_loc(bin.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(bin.loc.clone(), self.current_file_path()),
    ...
    fn resolve_prefix_expr(&mut self, module_id: ModuleID, prefix: &PrefixExpr) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Prefix(TypedPrefixExpr {
                operand: Box::new(operand),
                op: prefix.op.clone(),
                loc: Loc::from_loc(prefix.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(prefix.loc.clone(), self.current_file_path()),
    ...
    fn resolve_assign_expr(&mut self, module_id: ModuleID, assignment: &Assign) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Assign(TypedAssignExpr {
                ...
                loc: Loc::from_loc(assignment.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(assignment.loc.clone(), self.current_file_path()),
                    ...
                    match string_prefix {
                        StringPrefix::B => {
                            ...
                            Some(SemanticType::Array(TypedArrayType {
                                ...
                                loc: Loc::from_loc(literal.loc.clone(), self.current_file_path()),
                            }))
                        }
    ...
    fn resolve_unary_expr(&mut self, module_id: ModuleID, unary: &UnaryExpr) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::Unary(TypedUnaryExpr {
                op: unary.op.clone(),
                operand: Box::new(operand),
                loc: Loc::from_loc(unary.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(unary.loc.clone(), self.current_file_path()),
    ...
    fn resolve_array_index_expr(&mut self, module_id: ModuleID, array_index: &ArrayIndex) -> Option<TypedExprStmt> {
        ...
        Some(TypedExprStmt {
            kind: TypedExprKind::ArrayIndex(TypedArrayIndexExpr {
                operand: Box::new(operand),
                index: Box::new(index),
                loc: Loc::from_loc(array_index.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::LValue,
            sema_ty: None,
            loc: Loc::from_loc(array_index.loc.clone(), self.current_file_path()),
    ...
    fn resolve_address_of_expr(&mut self, module_id: ModuleID, address_of: &AddrOf) -> Option<TypedExprStmt> {
        let operand = self.resolve_expr(module_id, scope_opt, &address_of.expr)?;

        Some(TypedExprStmt {
            kind: TypedExprKind::AddrOf(TypedAddrOfExpr {
                operand: Box::new(operand),
                loc: Loc::from_loc(address_of.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::LValue,
            sema_ty: None,
            loc: Loc::from_loc(address_of.loc.clone(), self.current_file_path()),
    ...
    fn resolve_deref_expr(&mut self, module_id: ModuleID, dereference: &Deref) -> Option<TypedExprStmt> {
        let operand = self.resolve_expr(module_id, scope_opt, &dereference.expr)?;

        Some(TypedExprStmt {
            kind: TypedExprKind::Deref(TypedDerefExpr {
                operand: Box::new(operand),
                loc: Loc::from_loc(dereference.loc.clone(), self.current_file_path()),
            }),
            mloc: MemoryLocation::RValue,
            sema_ty: None,
            loc: Loc::from_loc(dereference.loc.clone(), self.current_file_path()),
