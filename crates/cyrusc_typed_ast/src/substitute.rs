...
//     ctx: Rc<RefCell<GenericMappingCtx>>,
// ) -> Option<FuncDecl> {
//     let params = substitute_func_params(mapping_ctx_arena.clone(), &func_decl.params, ctx.clone())?;
//     let ret_type = substitute_type(mapping_ctx_arena.clone(), func_decl.ret_type.clone(), ctx)?;
...
//     Some(StructDecl {
//         symbol_id: struct_decl.symbol_id,
...
//     Some(UnionDecl {
//         symbol_id: union_decl.symbol_id,
