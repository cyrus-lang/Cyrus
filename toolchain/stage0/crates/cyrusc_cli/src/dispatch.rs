...
use cyrusc_scaffold::version::VERSION;
...
pub fn dispatch(args: Args) {
    match args.cmd {
        ...
        Commands::Run {
            ...
            let (compiler_options, file_path, _) =
                prepare_compiler_options!(compiler_options, linker_options, file_path, None::<Option<PathBuf>>);
        ...
        Commands::SemanticOnly {
            ...
            let (compiler_options, file_path) = prepare_compiler_options!(compiler_options, file_path);
